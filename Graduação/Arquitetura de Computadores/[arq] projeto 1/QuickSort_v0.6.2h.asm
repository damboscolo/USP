...
#	- Função Swap consertada. (espero)
#	- Inserido loop para voltar ao inicio do programa, a nao ser que seja digitado 0
#	- Inserido strings "Vetor Ordenado/Vetor Original" antes dos vetores
#
# Atençao:
...
quicksort:
					...
					addi $t0, $t0, 4 #$t0 + 4 (numero de bytes para o proximo numero do vetor) para comecar um novo loop do quicksort
