...
#	- Função quicksort implementada por completo.
#
# Atençao:
#	- Bug na linha 276, na função vect_part.
...
loop_print: lw $a0, 0($t0) #armazena em $a0 o valor de %t0 + 0
			...
			li $a1, 0 #$a1 recebe 0, a posicao inicial do vetor
