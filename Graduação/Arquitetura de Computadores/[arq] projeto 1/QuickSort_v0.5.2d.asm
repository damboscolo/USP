...
loop_print: lw $a0, 0($t0) #armazena em $a0 o valor de %t0 + 0
			...
			addi $a1, 0 #$a1 recebe 0, a posicao inicial do vetor
			move $t0, $s0 #move N para $t0 para nao perder o valor
			addi $t0, -1 #diminui o valor de $t0 em 1 para indicar o final do vetor
...
#
quicksort:
					sgt $t0, $a2, $a1 #caso o valor da direita seja maior que o da esquerda, coloca 1 em $t0.
					addi $t4, 1 #para comparacao com $t0
					beq $t0, $zero, end_quicksort #finaliza caso $t0 seja igual a 0
					beq $t0, $t4, start_quicksort #inicia caso $t1 seja igual a 1
					
start_quicksort:	move $t0, $v0 #move o valor de $v0 para $t0, evitando que ele se perca
					addi $t0, -1 #$t0 - 1 para comecar um novo loop do quicksort
