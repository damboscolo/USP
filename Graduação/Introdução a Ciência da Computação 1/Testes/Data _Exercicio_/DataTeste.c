...
void test1(void) {
	...
	int saida_esperada = 1;
	int saida_obtida = data(dia, mes, ano);

	CU_ASSERT_EQUAL(saida_esperada, saida_obtida);

}

void test2(void) {

	/* Escreva seu código para o teste 2 aqui */

}


/* Crie mais testes aqui, conforme os anteriores */
