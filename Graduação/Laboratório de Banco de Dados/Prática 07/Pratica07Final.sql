...
-- EXERCICIO 2d)-- Pesquise o conceito de correlação (“Interpretação do coeficiente de correlação”) e analise o sinal (positivo ou negativo) e a magnitude da correlação para 2 pares de seleções. Se necessário, insira dados.
CREATE OR REPLACE
